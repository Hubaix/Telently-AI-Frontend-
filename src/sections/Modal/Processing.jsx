  ...
  return (
    <>
      {isOpen && (
        ...
        >
          <div class="modal-dialog processing-bg !max-w-[680px] !w-full h-auto min-h-[600px] !max-h-[600px] !border-0 rounded-[10px] p-4 md:p-12 !shadow-3xl bg-job-processing bg-cover bg-no-repeat flex justify-center items-center bg-black">
