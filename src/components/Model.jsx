        ...
        >
          <div className="modal-dialog !max-w-[616px] !w-full bg-white !border-0 rounded-[10px] !shadow-3xl">
            <div className="modal-content max-h-[95vh] overflow-y-auto flex flex-col">
              <div className="overflow-y-auto px-8 sm:pl-[50px] sm:pr-9 flex">
                <div className="w-full px-0 md:pt-[85px] pt-10 pb-6 flex flex-col overflow-y-auto">
                  <h2 className="font-bold text-[27px] text-[#312A50] text-center leading-[134%] mb-2">
                    Terms of Service
                  </h2>
                  <div className="pr-5 mt-4 overflow-y-auto sm:pr-9 terms__modal-scrollbar">
                    <div className="mb-10">
                      <div className=" prose prose-stone  prose-a:text-blue-500 prose-p:text-sm prose-li:text-sm prose-ol:text-sm ">
                        <h2 className="text-[#1c1917] font-bold text-[1.5em] mb-[1em]">AGREEMENT TO OUR LEGAL TERMS</h2>
                        <p>
                          We are Creativemorph Inc, doing business as Remotebase
                          and Talently.ai ("<strong>Company</strong>," "
                          <strong>we</strong>," "<strong>us</strong>," "
                          <strong>our</strong>"), a company registered in
                          California, United States at 55 E 3rd Avenue, San
                          Mateo, CA 94401.
                        </p>
                        <p>
                          We operate the website{" "}
                          <a href="https://talently.ai/">
                            https://talently.ai/
                          </a>
                        ...
                        <p>
                          Talently is an AI interview agent that conducts live,
                          conversational interviews and gives real-time
                          evaluations to effortlessly identify top performers.
                        </p>
                        <p>
                          You can contact us by phone at 6503055112, email at
                          qasim@remotebase.com, or by mail to 55 E 3rd Avenue,
                        ...
                        <p>
                          ...
                          behalf of an entity ("you"), and Creativemorph Inc,
                          ...
                          Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE
                        ...
                        <p>
                          ...
                          request to: qasim@remotebase.com. If we ever grant you
                          the permission to post, reproduce, or publicly display
                          any part of our Services or Content, you must identify
                          us as the owners or licensors of the Services,
                        ...
                        <p>
                          ...
                          boards, online forums, and other functionality during
                          which you may create, submit, post, display, transmit,
                          ...
                          photographs, music, graphics, comments, reviews,
                        ...
                        <p>
                          ...
                          your Contributions (including, without limitation,
                          ...
                          your Contributions, and to sublicense the licenses
                        ...
                        <p>
                          ...
                          name, and franchise name, as applicable, and any of
                        ...
                        <p>
                          ...
                          Contributions accessible through the Services by
                          linking your account through the Services to any of
                        ...
                        <ul>
                          <li>
                            ...
                            any Submission nor post any Contribution that is
                            illegal, harassing, hateful, harmful, defamatory,
                            obscene, bullying, abusive, discriminatory,
                            threatening to any person or group, sexually
                            explicit, false, inaccurate, deceitful, or
                            misleading;
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            the necessary rights and licenses to submit such
                            Submissions and/or Contributions and that you have
                            full authority to grant us the above-mentioned
                        ...
                        <p>
                          ...
                          no obligation to monitor any Contributions, we shall
                          have the right to remove or edit any Contributions at
                          any time without notice if in our reasonable opinion
                          we consider such Contributions harmful or in breach of
                          these Legal Terms. If we remove or edit any such
                        ...
                        <p>
                          ...
                          through the Services infringes upon any copyright you
                        ...
                        <p>
                          ...
                          unauthorized purpose; and (8) your use of the Services
                        ...
                        <p>
                          ...
                          fees, and you authorize us to charge your chosen
                          payment provider for any such amounts upon placing
                          your order. If your order is subject to recurring
                          charges, then you consent to our charging your payment
                          method on a recurring basis without requiring your
                          prior approval for each recurring charge, until such
                          time as you cancel the applicable order. We reserve
                        ...
                        <p>
                          ...
                          sole judgment, appear to be placed by dealers,
                        ...
                        <p>
                          We offer a 14-day free trial to new users who register
                          with the Services. The account will not be charged and
                          the subscription will be suspended until upgraded to a
                          paid version at the end of the free trial.
                        </p>
                        <h3>
                        ...
                        <p>
                          ...
                          us at qasim@remotebase.com or call us at 6503055112.
                        </p>
                        <h3>
                        ...
                        <p>
                          ...
                          posted on the Services, which is incorporated into
                          these Legal Terms. Please be advised the Services are
                          hosted in the United States. If you access the
                          Services from any other region of the world with laws
                          or other requirements governing personal data
                          collection, use, or disclosure that differ from
                          applicable laws in the United States, then through
                          ...
                          children or knowingly market to children. Therefore,
                        ...
                        <h3>
                          <strong>13. COPYRIGHT INFRINGEMENTS</strong>
                        </h3>
                        <p>
                          We respect the intellectual property rights of others.
                          If you believe that any material available on or
                          through the Services infringes upon any copyright you
                          own or control, please immediately notify us using the
                          ...
                          applicable law you may be held liable for damages if
                          you make material misrepresentations in a
                        ...
                        <p>
                          ...
                          of the State of California applicable to agreements
                          made and to be entirely performed within the State of
                        ...
                        <p>
                          ...
                          of which are available at the American Arbitration
                          ...
                          arbitration will take place in San Mateo, California.
                        ...
                        <p>
                          ...
                          San Mateo, California, and the Parties hereby consent
                        ...
                        <p>
                          ...
                          related in any way to the Services be commenced more
                          than one (1) years after the cause of action arose. If
                        ...
                        <p>
                          ...
                          AND USE OF THE SERVICES, (3) ANY UNAUTHORIZED ACCESS
                        ...
                        <p>
                          ...
                          AMOUNT PAID, IF ANY, BY YOU TO US DURING THE six (6)
                          MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR
                          $10,000.00 USD. CERTAIN US STATE LAWS AND
                        ...
                        <p>
                          ...
                          out of: (1) your Contributions; (2) use of the
                          Services; (3) breach of these Legal Terms; (4) any
                          ...
                          act toward any other user of the Services with whom
                          ...
                          agree to cooperate, at your expense, with our defense
                        ...
                        <p>
                          <strong>Creativemorph Inc</strong>
                          <br />
                          <strong>55 E 3rd Avenue</strong>
                          <br />
                          <strong>San Mateo, CA 94401</strong>
                          <br />
                          <strong>United States</strong>
                          <br />
                          <strong>Phone: 6503055112</strong>
                          <br />
                          <strong>qasim@remotebase.com</strong>
                        </p>
                      </div>
                    </div>
              ...
              <div className="w-full flex justify-center py-[22px]">
                <div className="max-w-[618px] w-full mx-auto px-6 mobileXl:gap-4 gap-[10px] flex mobileXl:flex-row flex-col  justify-center items-center">
                  <button 
                    className="flex flex-shrink-0 items-center justify-center text-sm font-avenir font-medium tracking-[-0.14px] mx-auto text-[#F9FAFB] px-5 py-2 min-w-[145px] min-h-[49px] border-[4px] border-solid border-[#E5E7EB] rounded-[14px] transition-all bg-gradient-btn hover:text-white focus:text-white hover:bg-gradient-btn-2 focus:bg-gradient-btn-2"
                    onClick={onClose}
                  >
                    Close
                  </button>
